...
const FormDesk = () => {
    return (
        <div className="py-16 flex flex-col items-center gap-16 justify-center w-5/6 m-auto">
            ...
            <article className="text-title_gray flex flex-col items-center justify-center w-5/6 md:w-[54.2rem] gap-6 ">
            ...
            <section className="grid grid-cols-2 gap-6 w-full md:w-4/6 text-title_gray text-sm md:text-base">
                <div>
                ...
                <div className="col-span-2">
                    <label className="flex w-full pl-1 pr-8">
                        ...
                        <div className="w-6 h-6 border-[1.5px] border-Ybutton rounded-md peer-checked:bg-Ybutton peer-checked:border-Ybutton mr-6">
                            <Check className="text-white" />
                        </div>
                        <span className="flex-1 text-xs md:text-base ">
